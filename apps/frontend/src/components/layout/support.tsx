...
export const Support = () => {
  ...
  return (
    <div
      id="support-discord"
      className="bg-ink w-[194px] h-[58px] fixed end-[20px] bottom-[20px] z-[500] text-[16px] text-newBgColor rounded-[30px] !rounded-br-[0] cursor-pointer flex justify-center items-center gap-[10px]"
