      ...
      {!canEdit && !isCreateSet && (
        <>
          ...
          >
            ...
            <div>
              <div className="text-white rounded-[8px] h-[44px] px-[20px] bg-brand cursor-pointer flex justify-center items-center">
                  ...
                  toolBar={
                    <div className="flex gap-[5px]">
                      ...
                      <div
                        ...
                        className="select-none cursor-pointer rounded-[6px] w-[30px] h-[30px] bg-surface border border-line flex justify-center items-center"
