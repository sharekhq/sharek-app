      ...
      <div className="flex flex-1 bg-newBgColorInner rounded-[20px] flex-col">
              ...
              >
                <div className="flex-1 flex flex-col rounded-[12px] gap-[12px] overflow-hidden bg-newSettings">
                  <div
                    ...
                    className={clsx(
                      'bg-[#0F0E0D] rounded-[12px] flex items-center gap-[8px] cursor-pointer p-[12px]',
        ...
        <div className="select-none h-[84px] py-[20px] border-t border-newBorder flex items-center">
          ...
          <div className="pe-[20px] flex items-center justify-end gap-[8px]">
            ...
            {addEditSets && (
              <button
                className="text-white text-[15px] font-[600] min-w-[180px] btnSub disabled:cursor-not-allowed disabled:opacity-80 outline-none gap-[8px] flex justify-center items-center h-[44px] rounded-[8px] bg-[#0F0E0D] ps-[20px] pe-[16px]"
                disabled={
                  selectedIntegrations.length === 0 || loading || locked
                }
                onClick={schedule('draft')}
            ...
            {!addEditSets && (
              <div className="group cursor-pointer relative">
                <button
                  ...
                  className="text-white relative min-w-[180px] btnSub disabled:cursor-not-allowed disabled:opacity-80 outline-none gap-[8px] flex justify-center items-center h-[44px] rounded-[8px] bg-[#0F0E0D] ps-[20px] pe-[16px]"
                >
                  {loading && (
                    <div className="absolute left-[50%] top-[50%] -translate-y-[50%] -translate-x-[50%]">
                ...
                {!dummy && (
                  <button
                    ...
                    className="rounded-[8px] z-[300] disabled:cursor-not-allowed disabled:opacity-80 hidden group-hover:flex absolute bottom-[100%] -left-[12px] mb-[8px] w-[206px]"
                  >
