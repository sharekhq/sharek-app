  ...
  const register = async () => {
    ...
    try {
      const response = await fetch('/integrations/moltbook/register', {
        ...
        body: JSON.stringify({
          name: agentName.trim(),
          description: agentDescription.trim() || 'Sharek social media scheduler',
        }),
      });
        ...
        <>
          ...
          <div className="w-full space-y-[12px]">
            ...
            <Input
              ...
              placeholder={t('placeholder_social_media_scheduler', 'Social media scheduler')}
            />
