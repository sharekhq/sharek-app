      ...
      <div className="mb-6 flex gap-[12px]">
        <form className="flex-1 space-y-2" onSubmit={handleSubmit(submit)}>
          <textarea
            ...
            className="flex w-full p-[16px] h-[98px] text-sm outline-none focus-visible:ring-2 focus-visible:ring-brand disabled:cursor-not-allowed disabled:opacity-50 min-h-[80px] resize-none text-textColor bg-third border border-tableBorder rounded-[8px]"
