...
export const EmbeddedBilling: FC<{
  ...
  return (
    <div className="flex flex-col w-full pt-[48px] billing-form flex-1 mobile:pt-0">
      <CheckoutProvider
        stripe={stripe}
        options={{
          clientSecret: secret,
...
const SubmitBar: FC<{ loading: boolean }> = ({ loading }) => {
  ...
  return (
    <div className="animate-fadeIn h-[92px] mobile:h-auto fixed bottom-0 w-full px-[12px] pb-[12px] left-0 bg-newBgColor z-[100]">
      <div className="w-full h-full border-t border-newColColor bg-newBgColorInner px-[80px] mobile:px-[33px] mobile:!px-[16px] flex mobile:flex-col gap-[32px] mobile:gap-[16px] justify-end items-center font-[400] text-[14px] text-muted mobile:py-[16px]">
