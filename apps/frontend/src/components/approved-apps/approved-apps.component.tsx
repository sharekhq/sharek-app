      ...
      <div className="flex flex-col">
        ...
        <div className="text-muted mt-[4px]">
          {t(
            ...
            'Applications you have authorized to access your Sharek account.'
          )}
        </div>
      </div>
              ...
              >
                <div className="flex items-center gap-[12px]">
                  {app.oauthApp?.picture?.path ? (
                    ...
                    <div className="w-[40px] h-[40px] rounded-full bg-fifth flex items-center justify-center text-muted">
