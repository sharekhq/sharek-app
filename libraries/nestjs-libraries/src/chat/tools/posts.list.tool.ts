...
Posts cannot be deleted through the Sharek tools - if the user wants to delete a post, tell them to do it themselves in the Sharek app; never offer to delete a post.
`,
