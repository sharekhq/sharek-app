...
const TIKTOK_VISIBILITY_MESSAGE = 'Choose who can see this post.';
...
export class TikTokDto {
  ...
  // order. The four values are not in the sentence either: the composer also
  // renders it under the field, and callers who need them read them from the
  // enum @IsIn puts in the generated schema.
